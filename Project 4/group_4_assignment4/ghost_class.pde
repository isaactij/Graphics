class ghost{
  ...
  void writePath(){
    ...
    //(252.5, 22.5) to left  ******************************************************************************************
    point = 22.5;
    for(float i = 252.5; i <= 422.5; i += 0.5){
      path[int(i * 10)][int(point * 10)] = 1;
    }
    //(422.5, 22.5) down
    point = 422.5;
    ...
    //(422.5, 373.5) to right
    point = 373.5;
    for(float i = 422.5; i >= 387.5; i -= 0.5){
      path[int(i * 10)][int(point * 10)] = 1;
    }
    //(67.5, 373.5) down
    point = 67.5;
  ...
  void move(){
    ...
    if(x != 227.5 && change == 0){
      path = pac.path();
      //float point = 227.5;
      //for(float i = 228; i >= 187.5; i -= 0.5){
      //  path[int(point * 10)][int(i * 10)] = 0;
      //}
      change++;
    }
