class bird { //<>//
  ...
  void movebirds(float predX, float predY, boolean stopped, float scavX, float scavY) {
    ...
    if (!eaten1) {
      movebird1(scavX, scavY);
    }
    if (!eaten2) {
      movebird2(scavX, scavY);
    }
    if (!eaten3) {
      movebird3(scavX, scavY);
    }
    if (!eaten4) {
      movebird4(scavX, scavY);
    }
    if (!eaten5) {
      movebird5(scavX, scavY);
    }
    if (!eaten6) {
      movebird6(scavX, scavY);
    }
    //println(leaderX + "x");
    //println(leaderY + "y");
  }
  ...
  void movebird1(float scavX, float scavY) {
  ...
  void movebird2(float scavX, float scavY) {
    if (x2 == predatorX && y2 == predatorY && dead1) {
      dead2 = true;
    }
    if (dead2) {
      y2++;
      if (y2 >= 500 || (y2 - 1 == scavY && x2 == scavX)) {
        eaten2 = true;
        x2 = 50;
        y2 = 50;
      }
  ...
  void movebird3(float scavX, float scavY) {
    if (x3 == predatorX && y3 == predatorY && dead1 && dead2) {
      dead3 = true;
    }
    if (dead3) {
      y3++;
      if (y3 >= 500 || (y3 - 1 == scavY && x3 == scavX)) {
        eaten3 = true;
        x3 = 50;
        y3 = 50;
      }
  ...
  void movebird4(float scavX, float scavY) {
    if (x4 == predatorX && y4 == predatorY && dead1 && dead2 && dead3) {
      dead4 = true;
    }
    if (dead4) {
      y4++;
      if (y4 >= 500 || (y4 - 1 == scavY && x4 == scavX)) {
        eaten4 = true;
        x4 = 50;
        y4 = 50;
      }
  ...
  void movebird5(float scavX, float scavY) {
    if (x5 == predatorX && y5 == predatorY && dead1 && dead2 && dead3 && dead4) {
      dead5 = true;
    }
    if (dead5) {
      y5++;
      if (y5 >= 500 || (y5 - 1 == scavY && x5 == scavX)) {
        eaten5 = true;
        x5 = 50;
        y5 = 50;
      }
  ...
  void movebird6(float scavX, float scavY) {
    if (x6 == predatorX && y6 == predatorY && dead1 && dead2 && dead3 && dead4 && dead5) {
      dead6 = true;
    }
    if (dead6) {
      y6++;
      if (y6 >= 500 || (y6 - 1 == scavY && x6 == scavX)) {
        eaten6 = true;
        x6 = 50;
        y6 = 50;
      }
